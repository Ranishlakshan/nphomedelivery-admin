...
class CountForm extends StatefulWidget {
  ...
  const CountForm({ this.cat1, this.globalKey }) ;

  //const CountForm({Key key, this.globalKey}) : super(key: key);
  @override
    ...
    return Card(
      child: Form(
        ...
        child: Column(children: <Widget>[
          Text(widget.cat1,style: TextStyle(letterSpacing: 2),),
          ...
          RaisedButton(
              ...
              onPressed: () {
                //String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyFashion.currentState.validate()){
